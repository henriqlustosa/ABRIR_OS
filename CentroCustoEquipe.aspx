...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        .grid-wrap{margin-top:8px;background:#fff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;box-shadow:0 1px 2px rgba(0,0,0,.04)}
        .grid-header{display:flex;justify-content:space-between;align-items:center;padding:12px 16px;background:#f3f4f6;border-bottom:1px solid #e5e7eb}
        .grid-header h4{margin:0;font-size:18px;color:#1f2937;font-weight:600}
        .resp-chip{display:inline-flex;align-items:center;gap:8px;padding:6px 10px;border-radius:999px;background:#e6f0ff;color:#1e40af;font-weight:600;font-size:14px;border:1px solid #bfdbfe}
        .grid-style{width:100%;border-collapse:collapse}
        .grid-style th,.grid-style td{padding:10px 12px;border:1px solid #e5e7eb}
        .grid-style th{background:#f9fafb;color:#374151;text-align:left;font-weight:700}
        .grid-style tr:nth-child(even) td{background:#fafafa}
        .grid-style tr:hover td{background:#f1f5f9}
        .col-nome{width:34%}.col-login{width:12%;white-space:nowrap}.col-ccusto{width:36%}.col-numero{width:10%;white-space:nowrap;text-align:right}.col-resp{width:18%}
    </style>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- ===== Modo 2: vários trios (cada trio vira seção com chips + Grid de membros) ===== -->
